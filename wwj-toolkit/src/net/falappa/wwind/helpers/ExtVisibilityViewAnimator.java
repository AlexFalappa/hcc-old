 ...
 */
public class ExtVisibilityViewAnimator extends BasicAnimator {
    ...
    protected ExtVisibilityViewController viewController;
    protected boolean haveTargets;
    protected Position centerPosition;
    protected double zoom;

    public ExtVisibilityViewAnimator(final double smoothing, OrbitView view, ExtVisibilityViewController viewController) {
