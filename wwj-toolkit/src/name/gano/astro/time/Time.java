...
//        System.out.println("DT: " + t.deltaT( t.getMJD() )*60*60*24 );
     ...
     *
     * @param milliseconds number of millisconds as in from the function
     ...
     *
     * @param seconds number of seconds to add to current time (can be
     * fractional)
     */
...
//    }
    ...
    /**
     * Updates the Julian and Julian Epehermis Dates using Current
     * GregorianCalendar
     */
    ...
    /**
     * Gets the Modified Julian Ephemeris Date (Julian date minus 2400000.5)
     * (TT)
     *
    ...
    /**
     * Sets timezone for the output string to use via the function
     * getDateTimeStr()
     *
     ...
     *
     * @param formatStr String format for simple date format to use for creating
     * strings of the date
     */
     ...
     *
     * <p>
     * Up to 1983 Ephemeris Time (ET) was used in place of TT, between 1984 and
     * 2000 Temps Dynamique Terrestrial (TDT) was used in place of TT. The three
     * time scales, while defined differently, form a continuous time scale for
     * most purposes. TT has a fixed offset from TAI (Temps Atomique
     * International).
     *
     * <p>
     * This method returns the difference TT - UT in days. Usually this would be
     * looked up in a table published after the fact. Here we use polynomial
     * fits for the distant past, for the future and also for the time where the
     * table exists. Except for 1987 to 2015, the expressions are taken from
     * Jean Meeus, 1991, <I>Astronomical Algorithms</I>, Willmann-Bell, Richmond
     * VA, p.73f. For the present (1987 to 2015 we use our own graphical linear
     * fit to the data 1987 to 2001 from USNO/RAL, 2001, <I>Astronomical
     * Almanach 2003</I>, U.S. Government Printing Office, Washington DC, Her
     ...
     * t = (Ep - 1900) / 100
     * <p>
     * DeltaT/d = -0.000020 + 0.000297 * t + 0.025184 * t<sup>2</sup> - 0.181133
     * * t<sup>3</sup><BR>
     * + 0.553040 * t<sup>4</sup> - 0.861938 * t<sup>5</sup>
     * + 0.677066 * t<sup>6</sup> - 0.212591 * t<sup>7</sup>
     *
     * <p>
     * This work dates from 1988 and the equation is supposed to be valid only
     * to 1987, but we extend its use into the near future. For the 19th century
     * we use Schmadl and Zech:
     *
     * <p>
     * t = (Ep - 1900) / 100
     * <p>
     * DeltaT/d = -0.000009 + 0.003844 * t + 0.083563 * t<sup>2</sup> + 0.865736
     * * t<sup>3</sup><BR>
     ...
     *
     * <p>
     * Stephenson and Houlden are credited with the equations for times before
     * 1600. First for the period 948 to 1600:
     *
     * <p>
     * t = (Ep - 1850) / 100
     * <p>
     * DeltaT/s = 22.5 * t<sup>2</sup>
     *
     * <p>
     * and before 948:
     *
     ...
     * t = (Ep - 948) / 100
     * <p>
     * DeltaT/s = 1830 - 405 * t + 46.5 * t<sup>2</sup>
     *
     * <p>
     * This leaves no equation for times between 1600 and 1800 and beyond 2015.
     * For such times we use the equation of Morrison and Stephenson:
     *
     * <p>
     * t = Ep - 1810
     * <p>
     * DeltaT/s = -15 + 0.00325 * t<sup>2</sup>
     *
