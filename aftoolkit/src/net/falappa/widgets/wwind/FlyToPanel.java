...
import net.falappa.widgets.wwind.posparser.PositionParser;
...
public class FlyToPanel extends javax.swing.JPanel {
    ...
    public FlyToPanel() {
        ...
        hint.setForeground(UIManager.getDefaults().getColor("Button.shadow"));
    ...
    public void removeParserAt(int idx) {
        parsers.remove(idx);
    }
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {bGo, bNextLoc, bPrevLoc});
