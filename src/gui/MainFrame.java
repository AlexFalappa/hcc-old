...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		globePanel.setBorder(BorderFactory
		...
		catalogueCombo = new JComboBox<String>(new String[] {
				"http://hmal:8080/HmaLWS/services/catalogue",
				"http://localhost:8080/HmaLWS/services/catalogue",
				"http://telespazio.it/cosmocatalogue",
				"http://organization.int/catalog", "http://private.com/cat" });
	...
	public CatalogueStub getWebServStub() throws AxisFault {
		if (catServiceStub == null)
			catServiceStub = new CatalogueStub(catalogueCombo.getSelectedItem()
					.toString());
