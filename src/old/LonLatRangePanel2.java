...
public class LonLatRangePanel2 extends JPanel {
    ...
    private JLabel lblMaxLat;
    private JLabel lblMinLat;
    private JLabel lblMaxLon;
    private JLabel lblMinLon;
    ...
    private void setSpinnersEnabled(boolean enabled) {
        lblMaxLat.setEnabled(enabled);
        spMaxLat.setEnabled(enabled);
        lblMaxLon.setEnabled(enabled);
        spMaxLon.setEnabled(enabled);
        lblMinLat.setEnabled(enabled);
        spMinLat.setEnabled(enabled);
        lblMinLon.setEnabled(enabled);
