...
public final class Slots {
    ...
    static {
        ...
        setReq(MetadataNames.PARENT_IDENTIFIER, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::parentIdentifier\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.PRODUCT_TYPE, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::productType\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.FOOTPRINT, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::multiExtentOf\"]/wrs:ValueList/wrs:AnyValue[1]");
        setReq(MetadataNames.START_SENSING, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::beginPosition\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.STOP_SENSING, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::endPosition\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.ORBIT_NUMBER, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::orbitNumber\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.ORBIT_DIRECTION, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::orbitDirection\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.ACQ_STATION, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::acquisitionStation\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.POLARISN_CHANNELS, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::polarisationChannels\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.POLARISN_MODE, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::polarisationMode\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.MIN_INCID_ANGLE, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::minimumIncidenceAngle\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.MAX_INCID_ANGLE, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::maximumIncidenceAngle\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.STATUS, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::status\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.SCENE_CENTER, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::centerOf\"]/wrs:ValueList/wrs:AnyValue[1]");
        setReq(MetadataNames.ACQ_DATE, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::acquisitionDate\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.ASC_NODE_LON, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::ascendingNodeLongitude\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.WRS_LON, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::wrsLongitudeGrid\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.WRS_LAT, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::wrsLatitudeGrid\"]/rim:ValueList/rim:Value[1]");
        setReq(MetadataNames.LOOK_SIDE, "/rim:ExtrinsicObject[@objectType=\"urn:ogc:def:objectType:OGC-CSW-ebRIM-EO::EOProduct\"]/rim:Slot[@name=\"urn:ogc:def:slot:OGC-CSW-ebRIM-EO::antennaLookDirection\"]/rim:ValueList/rim:Value[1]");
