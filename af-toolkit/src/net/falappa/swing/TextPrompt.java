 ...
 * <p>
 * The Show property is used to determine the visibility of the prompt. The Font and foreground Color of the prompt will default to those
 * properties of the parent text component. You are free to change the properties after class construction.
 * <p>
 * Taken from http://tips4java.wordpress.com/2009/11/29/text-prompt/
 * <p>
 * @author Rob Camick
 */
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
    ...
    /**
     * Convenience method to change the style of the current Font. The style values are found in the Font class. Common values might be:
     ...
     * <p>
     * Show.AWLAYS (default) - always show the prompt Show.Focus_GAINED - show the prompt when the component gains focus (and hide the
     * prompt when focus is lost) Show.Focus_LOST - show the prompt when the component loses focus (and hide the prompt when focus is
     * gained)
     * <p>
