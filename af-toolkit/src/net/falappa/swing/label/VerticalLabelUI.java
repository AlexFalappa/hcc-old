 ...
 */
package net.falappa.swing.label;
 ...
 * <P>
 * The only difference between the appearance of labels in the Basic and Metal L&Fs is the manner in which diabled text is painted. As
 * VerticalLabelUI does not override the method paintDisabledText, this class can be adapted for Metal L&F by extending MetalLabelUI instead
 * of BasicLabelUI.
 * <P>
...
public class VerticalLabelUI extends BasicLabelUI {
    ...
    /**
     * Transposes the view rectangles as appropriate for a vertical view before invoking the super method and copies them after they have
