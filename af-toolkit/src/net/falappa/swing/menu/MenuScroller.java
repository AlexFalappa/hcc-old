...
/**
 * A class that provides scrolling capabilities to a long menu dropdown or popup menu. A number of items can optionally be frozen at the top
 * and/or bottom of the menu.
 * <P>
 * <B>Implementation note:</B> The default number of items to display at a time is 15, and the default scrolling interval is 125
 * milliseconds.
 * <P>
 *
...
public class MenuScroller {
    ...
    /**
     * Registers a menu to be scrolled, with the specified number of items to display in the scrolling region, the specified scrolling
     ...
     * @throws IllegalArgumentException if scrollCount or interval is 0 or negative or if topFixedCount or bottomFixedCount is negative
     * @return the MenuScroller
     */
    public static MenuScroller setScrollerFor(JMenu menu, int scrollCount, int interval,
    ...
    /**
     * Registers a popup menu to be scrolled, with the specified number of items to display in the scrolling region, the specified scrolling
    ...
    /**
     * Constructs a <code>MenuScroller</code> that scrolls a menu with the default number of items to display at a time, and default
     * scrolling interval.
     * <p>
     * @param menu the menu
     */
    ...
    /**
     * Constructs a <code>MenuScroller</code> that scrolls a popup menu with the default number of items to display at a time, and default
     * scrolling interval.
     * <p>
     * @param menu the popup menu
     */
    ...
    /**
     * Constructs a <code>MenuScroller</code> that scrolls a menu with the specified number of items to display at a time, and default
     * scrolling interval.
     * <p>
     * @param menu        the menu
     * @param scrollCount the number of items to display at a time
    ...
    /**
     * Constructs a <code>MenuScroller</code> that scrolls a popup menu with the specified number of items to display at a time, and default
     * scrolling interval.
     * <p>
     * @param menu        the popup menu
     * @param scrollCount the number of items to display at a time
    ...
    /**
     * Constructs a <code>MenuScroller</code> that scrolls a menu with the specified number of items to display at a time, and specified
     * scrolling interval.
     * <p>
     * @param menu        the menu
     * @param scrollCount the number of items to display at a time
    ...
    /**
     * Constructs a <code>MenuScroller</code> that scrolls a popup menu with the specified number of items to display at a time, and
    ...
    /**
     * Constructs a <code>MenuScroller</code> that scrolls a menu with the specified number of items to display in the scrolling region, the
     ...
     * region, the specified scrolling interval, and the specified numbers of items fixed at the top and bottom of the popup menu.
     * <p>
     * @param menu             the popup menu
     * @param scrollCount      the number of items to display in the scrolling portion
     * @param interval         the scroll interval, in milliseconds
    ...
    /**
     * Scrolls the specified item into view each time the menu is opened. Call this method with <code>null</code> to restore the default
    ...
    /**
     * Scrolls the item at the specified index into view each time the menu is opened. Call this method with <code>-1</code> to restore the
     * default behavior, which is to show the menu as it last appeared.
     * <p>
