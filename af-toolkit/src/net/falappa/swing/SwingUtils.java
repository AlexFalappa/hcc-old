...
public final class SwingUtils {
     ...
     * instances of class <code>clazz</code> it finds. Returns an empty list if no such components exist in the container.
     * <P>
    ...
    /**
     * Convenience method that searches below <code>container</code> in the component hierarchy and returns the first found component that
     * is an instance of class <code>clazz</code> having the bound property value. Returns {@code null} if such component cannot be found.
     * <P>
     ...
     * @param container the container at which to begin the search
     * @param property  the className of the bound property, exactly as expressed in the accessor e.g. "Text" for getText(), "Value" for
     *                  getValue().
    ...
    /**
     * Convenience method that searches below <code>container</code> in the component hierarchy and returns the first found component that
     * is an instance of class <code>clazz</code> and has the bound property value. Returns {@code null} if such component cannot be found.
     *
     ...
     *                  getValue().
     * @param value     the value of the bound property
     * @param nested    true to list components nested within another component which is also an instance of <code>clazz</code>, false
     *                  otherwise
     * @return the component, or null if no such component exists in the container
     * @throws java.lang.IllegalArgumentException if the bound property does not exist for the class or cannot be accessed
     */
    ...
    /**
     * Convenience method for searching below <code>container</code> in the component hierarchy and return nested components of class
     * <code>clazz</code> it finds. Returns an empty list if no such components exist in the container.
     * <P>
    ...
    /**
     * Convenience method that searches below <code>container</code> in the component hierarchy in a depth first manner and returns the
     * first found component of class <code>clazz</code> having the bound property value.
     * <P>
    ...
    /**
     * Convenience method for mapping a container in the hierarchy to its contained components. The keys are the containers, and the values
     * are lists of contained components.
     * <P>
     * Implementation note: The returned value is a HashMap and the values are of type ArrayList. This is subject to change, so callers
     * should code against the interfaces Map and List.
     *
