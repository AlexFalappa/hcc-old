 ...
 * <P>
 * <B>Note:</B> This class is not suitable for wrapping an <CODE>ImageIcon</CODE> that holds an animated image. To show an animated
...
public class AlphaIcon implements Icon {
    ...
    /**
     * Creates an <CODE>AlphaIcon</CODE> with the specified icon and opacity. The opacity <CODE>alpha</CODE> should be in the range 0.0F
