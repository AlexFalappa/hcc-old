...
/**
 * The base class for displying an additional custom icon on a JCheckBox or JRadioButton. Subclasses should furnish the default Icon
 * provided by the Look and Feel using UIManager.getIcon(...).
 * <P>
...
public abstract class ToggleButtonIcon extends DualIcon {
    ...
    /**
     * Creates a <CODE>ToggleButtonIcon</CODE> with the specified horizontal and vertical positioning.
     * <p>
