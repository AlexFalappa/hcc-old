...
public class CheckBoxIcon extends ToggleButtonIcon {
    ...
    /**
     * Creates a <CODE>CheckBoxIcon</CODE> for a JCheckBox with the horizontal and vertical positioning derived from the horizontal and
    ...
    /**
     * Creates a <CODE>CheckBoxIcon</CODE> for a JCheckBox with the specified horizontal and vertical positioning.
     * <p>
     * @param checkBox           the check box
     * @param customIcon         the icon
