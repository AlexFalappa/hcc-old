...
/**
 * The RotatedIcon allows you to change the orientation of an Icon by rotating the Icon before it is painted. This class supports the
 ...
 * <li>ABOUT_CENTER - the icon is rotated a specfic angle about its center. The angle of rotation is specified when the class is created.
 * </ul>
 */
public class RotatedIcon implements Icon {
     ...
     * For rectangular icons the icon will be clipped before the rotation to make sure it doesn't paint over the rest of the component.
     * <p>
     * @param icon  the Icon to rotate
