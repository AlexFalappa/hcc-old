...
public class RadioButtonIcon extends ToggleButtonIcon {
    ...
    /**
     * Creates a <CODE>RadioButtonIcon</CODE> for a JRadioButton with the horizontal and vertical positioning derived from the horizontal
     * and vertical positions of the radio button's text relative to its icon.
     * <p>
    ...
    /**
     * Creates a <CODE>RadioButtonIcon</CODE> for a JRadioButton with the specified horizontal and vertical positioning.
     * <p>
     * @param radioButton        the radio button
     * @param customIcon         the icon
     * @param horizontalPosition the horizontal position of the custom icon relative to the default icon. One of the following values:
     * <ul>
     ...
     * <P>
     * @param verticalPosition   the vertical position of the custom icon relative to the default icon One of the following values:
     * <ul>
     * <li>{@code SwingConstants.CENTER}
