package net.falappa.swing.icon;
 ...
 * <ul>
 * <li>Horizontally - does normal rendering of the text by using the Graphics.drawString(...) method
 * <li>Vertically - Each character is displayed on a separate line
 * </ul>
 *
 * TextIcon was designed to be rendered on a specific JComponent as it requires FontMetrics information in order to calculate its size and
 * to do the rendering. Therefore, it should only be added to component it was created for.
 * <p>
 * By default the text will be rendered using the Font and foreground color of its associated component. However, this class does allow you
 * to override these properties. Also starting in JDK6 the desktop renderering hints will be used to renderer the text. For versions not
 * supporting the rendering hints antialiasing will be turned on.
 */
public class TextIcon implements Icon, PropertyChangeListener {
     ...
     * @param component the component to which the icon will be added
     * @param text      the text to be rendered on the Icon
     * @param layout    specify the layout of the text. Must be one of the Layout enums: HORIZONTAL or VERTICAL
     */
    ...
    /**
     * Get the Font used to render the text. This will default to the Font of the component unless the Font has been overridden by using the
     * setFont() method.
     * <p>
    ...
    /**
     * Get the foreground Color used to render the text. This will default to the foreground Color of the component unless the foreground
     * Color has been overridden by using the setForeground() method.
     * <p>
    ...
    /**
     * By default the size of the Icon is based on the size of the rendered text. You can specify some padding to be added to the start and
     * end of the text when it is rendered.
     * <p>
