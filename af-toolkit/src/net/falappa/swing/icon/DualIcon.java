...
/**
 * A composite Icon class used to compose two Icon objects into a single Icon by painting the icons in turn at the precomputed offsets. For
 * example, this class may be used to add a custom icon to a component like JCheckBox or JRadioButton, in addition to the default icon
...
public class DualIcon implements Icon, SwingConstants {
    ...
    /**
     * Creates a <CODE>DualIcon</CODE> with the specified icons, the default horizontal and vertical positioning and default gap.
     * <CODE>icon2</CODE> is positioned to the right of <CODE>icon1</CODE> with a 4 pixel gap, and the vertical centers of the icons are
     * aligned.
     * <p>
    ...
    /**
     * Creates a <CODE>DualIcon</CODE> with the specified icons, the specified horizontal and vertical positioning and the specified gap.
     * <p>
     * @param icon1              the first icon
     * @param icon2              the second icon
     ...
     * </ul>
     * <P>
     * @param iconIconGap        the gap between the icons in pizels, ignored if the horizontalPosition and verticalPosition are both
     ...
     * <p>
     * @param c The component to which the icon is painted, which may be used to get properties useful for painting, e.g. the foreground or
