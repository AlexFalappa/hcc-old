 ...
 * <P>
 * This class is suitable for wrapping an <CODE>ImageIcon</CODE> that holds an animated image. To show a non-animated Icon with
 * transparency, the companion class {@link AlphaIcon} is a lighter alternative.
 * <p>
...
public class AlphaImageIcon extends ImageIcon {
    ...
    /**
     * Creates an <CODE>AlphaImageIcon</CODE> with the specified icon and opacity. The opacity <CODE>alpha</CODE> should be in the range
     ...
     * <P>
     * In common with <code>ImageIcom</code>, the newly set image will only be shown when the concerned component(s) are repainted.
     * <p>
    ...
    /**
     * Overridden to return the status of the image loading operation of a wrapped ImageIcon, or 0 if the contained icon is not an
     * ImageIcon.
     * <p>
    ...
    /**
     * Gets the width of the bounding rectangle of this <CODE>AlphaImageIcon</CODE>. Overridden to return the width of the wrapped icom.
     * <p>
    ...
    /**
     * Gets the height of the bounding rectangle of this <CODE>AlphaImageIcon</CODE>. Overridden to return the height of the wrapped icon.
     * <p>
