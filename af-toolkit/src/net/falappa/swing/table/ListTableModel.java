...
public class ListTableModel extends RowTableModel<List> {
    ...
    /**
     * Initialize the List with null values. This will set the size of the List and will prevent an IndexOutOfBoundsException when trying to
    ...
    /**
     * Constructs an empty <code>ListTableModel</code> with default column names for the specified number of <code>columns</code>.
     * <p>
    ...
    /**
     * Constructs an empty <code>ListTableModel</code> with customized column names. The number of columns is determined bye the number of
     * items in the <code>columnNames</code> List.
     * <p>
    ...
    /**
     * Constructs a <code>ListTableModel</code> with the specified number of rows. Default column names will be used for the specified
    ...
    /**
     * Constructs a <code>ListTableModel</code> with initial data and customized column names.
     * <p>
...
//
    ...
    /**
     * Sets the object value for the cell at <code>column</code> and <code>row</code>.  <code>value</code> is the new value. This method will
     ...
     * <p>
     * The column names and class type will be retrieved from the ResultSetMetaData. The data is retrieved from each row found in the
