...
/**
 * This class will use a combo box as the editor for a JTable cell. It is different from the default combo box editor in that it supports
 * multiple combo box models. The appropriate model will be choosen based on the cell about to be edited.
 * <p>
 * The model to be used by the combo box is determined by the value contained in the cell of a related column. This value is used to lookup
 * the model.
 */
public class ComboBoxTableEditor extends DefaultCellEditor {
     ...
     * <p>
     * Convenience constructor. The related column is assumed to be the column to the left of the editing column.
     */
     ...
     * Create a combo box editor that supports different combo box models.
     * <p>
     * @param relatedColumn column whose value will be used to lookup the model to be used by the combo box
     */
