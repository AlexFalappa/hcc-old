...
/**
 * The BeanTableModel will use reflection to determine the columns of data to be displayed in the table model. Reflection is used to find
 * all the methods declared in the specified bean. The criteria used for adding columns to the model are:
 * <p>
 * a) the method name must start with either "get" or "is" b) the parameter list for the method must contain 0 parameters
 * <p>
 * You can also specify an ancestor class in which case the declared methods of the ancestor and all its descendents will be included in the
 * model.
 * <p>
...
public class BeanTableModel<T> extends RowTableModel<T> {
     ...
     * <p>
     * @param beanClass class of the beans that will be added to the model. The class is also used to determine the columns that will be
     ...
     * @param ancestorClass the methods of this class and its descendents down to the bean class can be included in the model.
     */
