 ...
 * <p>
 * 1) Select All editing - when a text related cell is placed in editing mode the text is selected. Controlled by invoking a
 * "setSelectAll..." method.
 * <p>
...
//
    /**
     * Constructs a default <code>RXTable</code> that is initialized with a default data model, a default column model, and a default
     * selection model.
     */
    public RXTable() {
        this(null, null, null);
    ...
    /**
     * Constructs a <code>RXTable</code> that is initialized with <code>dm</code> as the data model, a default column model, and a default
     * selection model.
     * <p>
    ...
    /**
     * Constructs a <code>RXTable</code> that is initialized with <code>dm</code> as the data model, <code>cm</code> as the column model,
    ...
    /**
     * Constructs a <code>RXTable</code> that is initialized with <code>dm</code> as the data model, <code>cm</code> as the column model,
     * and <code>sm</code> as the selection model. If any of the parameters are <code>null</code> this method will initialize the table with
     * the corresponding default model. The <code>autoCreateColumnsFromModel</code> flag is set to false if <code>cm</code> is non-null,
     * otherwise it is set to true and the column model is populated with suitable <code>TableColumns</code> for the columns in
     * <code>dm</code>.
     * <p>
     * @param dm the data model for the table
     * @param cm the column model for the table
    ...
    /**
     * Constructs a <code>RXTable</code> with <code>numRows</code> and <code>numColumns</code> of empty cells using
    ...
    /**
     * Constructs a <code>RXTable</code> to display the values in the <code>Vector</code> of <code>Vectors</code>, <code>rowData</code>,
     * with column names, <code>columnNames</code>. The <code>Vectors</code> contained in <code>rowData</code> should contain the values for
     * that row. In other words, the value of the cell at row 1, column 5 can be obtained with the following code:
     * <p>
     * <
    ...
    /**
     * Constructs a <code>RXTable</code> to display the values in the two dimensional array, <code>rowData</code>, with column names,
     * <code>columnNames</code>. <code>rowData</code> is an array of rows, so the value of the cell at row 1, column 5 can be obtained with
     * the following code:
     * <p>
     * <
     * pre> rowData[1][5]; </pre>
...
//
    /**
     * Convenience method to order the table columns of a table. The columns are ordered based on the column names specified in the array.
     * If the column name is not found then no column is moved. This means you can specify a null value to preserve the current order of a
     * given column.
     * <p>
