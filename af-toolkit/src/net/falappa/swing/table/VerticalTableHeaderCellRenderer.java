...
import net.falappa.swing.label.VerticalLabelUI;
...
public class VerticalTableHeaderCellRenderer
    ...
    private enum VerticalSortIcon implements Icon {
        ...
        /**
         * Paints an icon suitable for the header of a sorted table column, rotated by 90° clockwise. This rotation is applied to compensate
         * the rotation already applied to the passed in Graphics reference by the VerticalLabelUI.
         * <P>
