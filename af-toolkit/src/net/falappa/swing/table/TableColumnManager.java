...
/**
 * The TableColumnManager can be used to manage TableColumns. It will give the user the ability to hide columns and then reshow them in
 * their last viewed position. This functionality is supported by a popup menu added to the table header of the table. The TableColumnModel
 * is still used to control the view for the table. The manager will inovoke the appropriate methods of the TableColumnModel to hide/show
 * columns as required.
 * <p>
 */
public class TableColumnManager
     ...
     * <p>
     * @param menuPopop when true support for displaying a popup menu is added otherwise the popup menu is removed.
     */
