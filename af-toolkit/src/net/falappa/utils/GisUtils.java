 ...
 * <p>
 * Includes static methods for manipulating and converting lists of coordinates, a geodetic distance
 * routine, etc.
 */
public final class GisUtils {
    ...
    /**
     * Convert the list of lon lat coordinates pairs from a geometry expressed in WKT into a list of
     * lat lon pairs suitable for GML 3.1.1 &lt;gml:posList&gt; tag.
     * <p>
     * Examples:
     * <ul>
     ...
     * </ul>
     *
     * <b>Note:</b> it deals only with simple cases, does not handle multi primitives well nor
     * polygons with holes.
     *
    ...
    /**
     * Convert the list of lat lon coordinates pairs from a GML 3.1.1 &lt;gml:posList&gt; tag into a
     * list of lon lat pairs suitable for geometry expressed in WKT. The order of coordinate in
     * pairs is thus reversed.
     * <p>
     * Examples:
     * <ul>
    ...
    /**
     * Convert the list of lon lat coordinates pairs from the format used in COSMO Interoperability
     * Protocol into a list of lat lon pairs suitable for GML 3.1.1 &lt;gml:posList&gt; tag.
     * <p>
     * Examples:<br>
     * <ul>
     * <li>"[178:45;-170:45;-170:-45;178:-45;178:45]" is converted to "45 178 45 -170 -45 -170 -45
     * 178 45 178"</li>
    ...
    /**
     * Convert the list of lat lon coordinates pairs from a list of pairs suitable for GML 3.1.1
     * &lt;gml:posList&gt; tag into the format used in COSMO Interoperability Protocol (lon lat).
     * <p>
     * Examples:<br>
     * <ul>
     * <li>"178 45 -170 45 -170 -45 178 -45 178 45" is converted to
     * "[45:178;45:-170;-45:-170;-45:178;45:178]"</li>
     ...
     * <p>
     * Returned geometry is in WKT string format. Calculations are performed on the WGS84 geodetic
     * spheroid.
     *
    ...
    /**
     * Calculate a destination lat/long point given start point lat/long (in decimal degrees),
     * bearing angle (decimal degrees) and a distance (meters).
     *
     * The code employs the Vincenty direct formula from T.Vincenty, "Direct and Inverse Solutions
     * of Geodesics on the Ellipsoid with application of nested equations", Survey Review, vol XXII
     * no 176, 1975 http://www.ngs.noaa.gov/PUBS_LIB/inverse.pdf
     *
     * See http://www.movable-type.co.uk/scripts/latlong-vincenty-direct.html for explanation and
    ...
    /**
     * Computes the geodetic bounding box of a circle of the given center and radius and returns it
     * as a WKT bounding object string.
     * <p>
    ...
    /**
     * Returns a WKT polygon string representing a rectangle from the given lower left and upper
     * right corners.
     *
     * @param lowLeft string containing the lower left corner longitude and latitude separated by
     * whitespace
     * @param upRight string containing the upper right corner longitude and latitude separated by
     * whitespace
